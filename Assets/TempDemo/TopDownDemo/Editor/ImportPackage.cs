...
namespace TempDemo.TopDown
{
    ...
    public class ImportPackage
    {
        ...
        {
            if (!completed && DoesAssetExists("Assets/TempDemo/TopDownDemo/Prefabs/CharacterTopDown.prefab")){
                completed = true;
                marked_for_save = false;

                CreateSortingLayer("Perspective");
                CreateSortingLayer("Top");
                SetPrefabLayer("Assets/TempDemo/TopDownDemo/Prefabs/CharacterTopDown.prefab", "Perspective");
                SetPrefabLayer("Assets/TempDemo/TopDownDemo/Prefabs/Grass1.prefab", "Perspective");
                SetPrefabLayer("Assets/TempDemo/TopDownDemo/Prefabs/Grass2.prefab", "Perspective");
                SetPrefabLayer("Assets/TempDemo/TopDownDemo/Prefabs/Key.prefab", "Perspective");
                SetPrefabLayer("Assets/TempDemo/TopDownDemo/Prefabs/Lever.prefab", "Perspective");
